...
// Server Routes
app.get("/AmoyanSacopayo_task4_1", async (req, res) => {
    try {
...
app.get("/AmoyanSacopayo_task4_2", async (req, res) => {
    try {
        const sql = `SELECT e.first_name,e.last_name, 
...
app.get("/AmoyanSacopayo_task4_3", async (req, res) => {
    try {
...
app.get("/AmoyanSacopayo_task4_4", async (req, res) => {
    try {
        const sql = `SELECT e.first_name , e.last_name , 
        e.department_id ,  d.department_name 
        FROM employees e 
...
app.get("/AmoyanSacopayo_task4_5", async (req, res) => {
    try {
        const sql = `SELECT E.first_name,E.last_name,
        D.department_name, L.city, L.state_province
        FROM employees E 
...
app.get("/AmoyanSacopayo_task4_6", async (req, res) => {
    try {
...
app.get("/AmoyanSacopayo_task4_7", async (req, res) => {
    try {
...
app.get("/AmoyanSacopayo_task4_8", async (req, res) => {
    try {
...
app.get("/AmoyanSacopayo_task4_9", async (req, res) => {
    try {
...
app.get("/AmoyanSacopayo_task4_10", async (req, res) => {
    try {
...
app.get("/AmoyanSacopayo_task4_11", async (req, res) => {
    try {
        const sql = `SELECT E.first_name AS "Employee Name",
        M.first_name AS "Manager"
        FROM employees E 
...
app.get("/AmoyanSacopayo_task4_12", async (req, res) => {
    try {
...
app.get("/AmoyanSacopayo_task4_13", async (req, res) => {
    try {
...
app.get("/AmoyanSacopayo_task4_14", async (req, res) => {
    try {
...
app.get("/AmoyanSacopayo_task4_15", async (req, res) => {
    try {
